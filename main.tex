...
% Beyond these... is there any need for testing with multiple roaches; will you need machine vision to track the roaches / study not just their overall trajectory but their limb level mechanics? Is there any interest in transferring what you learn to either an engineered device / physical model (rc car w antennae?) or another organism or a human type task? 

...
% need a better title
\title{RoboRoach: active steering of neuromechanical preparations of American cockroaches (\emph{Periplaneta americana}) and Madagascar hissing cockroaches (\emph{Blaberus discoidalis})}
\author{Alexis Pak}
\date{\today}
